...
<html>
    ...
    <body>
		<div class="wrapper">
			<h1>Action your products here</h1>
			<div class="content">
				<div id="form_wrapper" class="form_wrapper">
					...
					<input type="hidden" name="_token" value="<?php echo csrf_token();?>"/>
						...
						<div class="bottom">
							<div class="remember"><input type="checkbox" name="Remember me" value="1" /><span>Keep me logged in</span></div>
